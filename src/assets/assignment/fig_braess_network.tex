...
\begin{scope}[xshift=0cm]
  ...
  %% リンク番号
  \node[font=\scriptsize, gray] at (1.0, 1.1)  {リンク1};
  \node[font=\scriptsize, gray] at (4.0, 1.1)  {リンク2};
  \node[font=\scriptsize, gray] at (1.0,-1.1)  {リンク3};
  \node[font=\scriptsize, gray] at (4.0,-1.1)  {リンク4};

  %% 均衡リンク交通量
  \node[font=\scriptsize] at (1.25, 0.52) {$x_1\!=\!3$};
  \node[font=\scriptsize] at (3.75, 0.52) {$x_2\!=\!3$};
  \node[font=\scriptsize] at (1.25,-0.52) {$x_3\!=\!3$};
  \node[font=\scriptsize] at (3.75,-0.52) {$x_4\!=\!3$};
...
\begin{scope}[xshift=7.2cm]
  ...
  %% 均衡リンク交通量
  \node[font=\scriptsize] at (1.3, 0.5) {$x_1\!=\!4$};
  \node[font=\scriptsize] at (3.7, 0.5) {$x_2\!=\!2$};
  \node[font=\scriptsize] at (1.3,-0.5) {$x_3\!=\!2$};
  \node[font=\scriptsize] at (3.7,-0.5) {$x_4\!=\!4$};
