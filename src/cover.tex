...
\begin{tikzpicture}[remember picture,overlay]
  ...
  \node[anchor=north west,text=black,font=\bfseries\fontsize{18}{26}\selectfont,align=left]
    at ($(current page.north west)+(20mm,-112mm)$) {%
      羽藤英二 \hspace{.5em} 編著\\
      小川大智 \hspace{.3em} 古橋郁一 \hspace{.3em} 松永隆宏 \hspace{.3em} 今村啓太 \hspace{.3em} 須賀理帆 \hspace{.5em} 著
      };
