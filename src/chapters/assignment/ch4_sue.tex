...
複数のルート案内アプリが一斌に特定の一般道を代替ルートとして案内しました．
その数分後，案内された道路は大渋滞に降りました．翌日の同じ時間帯，今度はその道路はどうなっていたでしょうか？
\begin{itemize}
...
\begin{enumerate}
  ...
  \item ロジット型SUE の均衡条件は \textbf{Fisk の等価最適化問題}
        （Beckmann 目的関数にエントロピー項 $-\theta^{-1}\sum_k f_k \log f_k$
        を加えた凸問題）として定式化でき，
...
「全員が同じ完全情報で一斌に動く」とき，日々振動が続く不安定なダイナミクスが生まれます．
