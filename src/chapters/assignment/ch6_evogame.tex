...
混雑ゲームの静学的 Nash 均衡分析（\sref{sec:ch3-ue}，補足C）は
...
\begin{figure}[hbtp]
  \centering
  \input{assets/assignment/fig_potential_z.tex}
...
\begin{figure}[hbtp]
  \centering
  \input{assets/assignment/fig_smith_dynamics.tex}
