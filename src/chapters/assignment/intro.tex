...
\begin{figure}[tb]
  \centering
  \input{assets/assignment/fig_4stages.tex}
...
\begin{description}
  ...
  \item[シミュレーションとの連携]
    ...
    ミクロシミュレーション（\sref{sec:ch8-simulation}）の初期条件・境界条件として配分結果が利用される\cite{Daganzo2007,Geroliminis2008}．
\end{description}
...
\begin{figure}[tb]
  \centering
  \input{assets/assignment/fig_model_overview.tex}
