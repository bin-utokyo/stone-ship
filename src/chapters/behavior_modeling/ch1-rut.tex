...
従って通常は Gumbel 分布を使用することが多い．
Gumbel 分布を用いたモデルを Probit Model と区別して Logit Modelと呼ぶ．
また選択肢が二つの場合は特に Binary Logit Model と呼び，複数の場合は Multinomial Logit Model と呼ぶ．

なお， Gumbel 分布と正規分布の確率密度関数は図\ref{fig:gumbel-pdf}のような形状をしている．
\begin{figure}[hbtp]
  \centering
...
一般に行動モデルの文脈で離散選択モデルを用いる際には，上記仮定を踏まえて誤差項に i.i.d. Gumbel 分布を仮定することが多い．
